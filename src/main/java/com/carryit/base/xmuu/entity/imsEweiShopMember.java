...
public class imsEweiShopMember {
    private Integer id;
    ...
    private Boolean membercardactive;

    private Integer levelendtime;
    ...
    public void setCarrierMobile(String carrierMobile) {
        this.carrierMobile = carrierMobile == null ? null : carrierMobile.trim();
    }
    ...
    public void setOpenidWa(String openidWa) {
        this.openidWa = openidWa == null ? null : openidWa.trim();
    }
    ...
    public void setNicknameWechat(String nicknameWechat) {
        this.nicknameWechat = nicknameWechat == null ? null : nicknameWechat.trim();
    }
    ...
    public void setAvatarWechat(String avatarWechat) {
        this.avatarWechat = avatarWechat == null ? null : avatarWechat.trim();
    }
    ...
    public void setMembershipnumber(String membershipnumber) {
        this.membershipnumber = membershipnumber == null ? null : membershipnumber.trim();
    }

    public Boolean getMembercardactive() {
        return membercardactive;
    }

    public void setMembercardactive(Boolean membercardactive) {
        this.membercardactive = membercardactive;
    }

    public Integer getLevelendtime() {
        return levelendtime;
    }

    public void setLevelendtime(Integer levelendtime) {
