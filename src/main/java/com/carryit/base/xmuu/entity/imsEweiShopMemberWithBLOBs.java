...
public class imsEweiShopMemberWithBLOBs extends imsEweiShopMember {
    ...
    public void setNoticeset(String noticeset) {
        this.noticeset = noticeset == null ? null : noticeset.trim();
    }
    ...
    public void setDiymemberfields(String diymemberfields) {
        this.diymemberfields = diymemberfields == null ? null : diymemberfields.trim();
    }
    ...
    public void setDiymemberdata(String diymemberdata) {
        this.diymemberdata = diymemberdata == null ? null : diymemberdata.trim();
    }
    ...
    public void setDiycommissionfields(String diycommissionfields) {
        this.diycommissionfields = diycommissionfields == null ? null : diycommissionfields.trim();
    }
    ...
    public void setDiycommissiondata(String diycommissiondata) {
        this.diycommissiondata = diycommissiondata == null ? null : diycommissiondata.trim();
    }
    ...
    public void setDiyglobonusdata(String diyglobonusdata) {
        this.diyglobonusdata = diyglobonusdata == null ? null : diyglobonusdata.trim();
    }
    ...
    public void setDiyglobonusfields(String diyglobonusfields) {
        this.diyglobonusfields = diyglobonusfields == null ? null : diyglobonusfields.trim();
    }
    ...
    public void setAagentprovinces(String aagentprovinces) {
        this.aagentprovinces = aagentprovinces == null ? null : aagentprovinces.trim();
    }
    ...
    public void setAagentcitys(String aagentcitys) {
        this.aagentcitys = aagentcitys == null ? null : aagentcitys.trim();
    }
    ...
    public void setAagentareas(String aagentareas) {
        this.aagentareas = aagentareas == null ? null : aagentareas.trim();
    }
    ...
    public void setDiyaagentdata(String diyaagentdata) {
        this.diyaagentdata = diyaagentdata == null ? null : diyaagentdata.trim();
    }
    ...
    public void setDiyaagentfields(String diyaagentfields) {
        this.diyaagentfields = diyaagentfields == null ? null : diyaagentfields.trim();
    }
    ...
    public void setDiyauthordata(String diyauthordata) {
        this.diyauthordata = diyauthordata == null ? null : diyauthordata.trim();
    }
    ...
    public void setDiyauthorfields(String diyauthorfields) {
        this.diyauthorfields = diyauthorfields == null ? null : diyauthorfields.trim();
    }
}