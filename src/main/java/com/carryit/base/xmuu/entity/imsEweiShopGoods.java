...
public class imsEweiShopGoods {
    ...
    private Boolean minpriceupdated;
    ...
    private Byte saleupdate40170;

    private Byte saleupdate35843;

    private Integer autoreceive;

    private Byte cannotrefund;

    private Byte saleupdate33219;
    ...
    private Byte saleupdate32484;

    private Byte saleupdate36586;

    private Integer diypage;

    private Boolean cashier;

    private Byte saleupdate53481;

    private Byte saleupdate30424;
    ...
    private Byte uniteTotal;

    private BigDecimal buyagainPrice;

    private String threen;

    private Boolean intervalfloor;

    private String intervalprice;

    private Byte isfullback;

    private Byte isstatustime;
    ...
    private Boolean verifygoodslimittype;
    ...
    public void setTaotaoid(String taotaoid) {
        this.taotaoid = taotaoid == null ? null : taotaoid.trim();
    }
    ...
    public void setCommissionThumb(String commissionThumb) {
        this.commissionThumb = commissionThumb == null ? null : commissionThumb.trim();
    }
    ...
    public void setNoticeopenid(String noticeopenid) {
        this.noticeopenid = noticeopenid == null ? null : noticeopenid.trim();
    }
    ...
    public void setFollowtip(String followtip) {
        this.followtip = followtip == null ? null : followtip.trim();
    }
    ...
    public void setFollowurl(String followurl) {
        this.followurl = followurl == null ? null : followurl.trim();
    }
    ...
    public void setDetailLogo(String detailLogo) {
        this.detailLogo = detailLogo == null ? null : detailLogo.trim();
    }
    ...
    public void setDetailShopname(String detailShopname) {
        this.detailShopname = detailShopname == null ? null : detailShopname.trim();
    }
    ...
    public void setDetailBtntext1(String detailBtntext1) {
        this.detailBtntext1 = detailBtntext1 == null ? null : detailBtntext1.trim();
    }
    ...
    public void setDetailBtnurl1(String detailBtnurl1) {
        this.detailBtnurl1 = detailBtnurl1 == null ? null : detailBtnurl1.trim();
    }
    ...
    public void setDetailBtntext2(String detailBtntext2) {
        this.detailBtntext2 = detailBtntext2 == null ? null : detailBtntext2.trim();
    }
    ...
    public void setDetailBtnurl2(String detailBtnurl2) {
        this.detailBtnurl2 = detailBtnurl2 == null ? null : detailBtnurl2.trim();
    }
    ...
    public void setDetailTotaltitle(String detailTotaltitle) {
        this.detailTotaltitle = detailTotaltitle == null ? null : detailTotaltitle.trim();
    }

    public Byte getSaleupdate42392() {
        return saleupdate42392;
    }

    public void setSaleupdate42392(Byte saleupdate42392) {
    ...
    public void setIsdiscountTitle(String isdiscountTitle) {
        this.isdiscountTitle = isdiscountTitle == null ? null : isdiscountTitle.trim();
    }
    ...
    public Boolean getMinpriceupdated() {
        return minpriceupdated;
    }

    public void setMinpriceupdated(Boolean minpriceupdated) {
    ...
    public void setCatchSource(String catchSource) {
        this.catchSource = catchSource == null ? null : catchSource.trim();
    }

    public Byte getSaleupdate40170() {
        return saleupdate40170;
    }

    public void setSaleupdate40170(Byte saleupdate40170) {
        this.saleupdate40170 = saleupdate40170;
    }

    public Byte getSaleupdate35843() {
        return saleupdate35843;
    }

    public void setSaleupdate35843(Byte saleupdate35843) {
    ...
    public Byte getSaleupdate33219() {
        return saleupdate33219;
    }

    public void setSaleupdate33219(Byte saleupdate33219) {
    ...
    public Byte getSaleupdate32484() {
        return saleupdate32484;
    }

    public void setSaleupdate32484(Byte saleupdate32484) {
        this.saleupdate32484 = saleupdate32484;
    }

    public Byte getSaleupdate36586() {
        return saleupdate36586;
    }

    public void setSaleupdate36586(Byte saleupdate36586) {
    ...
    public Byte getSaleupdate53481() {
        return saleupdate53481;
    }

    public void setSaleupdate53481(Byte saleupdate53481) {
        this.saleupdate53481 = saleupdate53481;
    }

    public Byte getSaleupdate30424() {
        return saleupdate30424;
    }

    public void setSaleupdate30424(Byte saleupdate30424) {
    ...
    public Byte getUniteTotal() {
        return uniteTotal;
    }

    public void setUniteTotal(Byte uniteTotal) {
    ...
    public void setThreen(String threen) {
        this.threen = threen == null ? null : threen.trim();
    }

    public Boolean getIntervalfloor() {
        return intervalfloor;
    }

    public void setIntervalfloor(Boolean intervalfloor) {
    ...
    public Byte getIsfullback() {
        return isfullback;
    }

    public void setIsfullback(Byte isfullback) {
        this.isfullback = isfullback;
    }

    public Byte getIsstatustime() {
        return isstatustime;
    }

    public void setIsstatustime(Byte isstatustime) {
        this.isstatustime = isstatustime;
    }

    public Integer getStatustimestart() {
        return statustimestart;
    }

    public void setStatustimestart(Integer statustimestart) {
        this.statustimestart = statustimestart;
    }

    public Integer getStatustimeend() {
        return statustimeend;
    }

    public void setStatustimeend(Integer statustimeend) {
    ...
    public Byte getShowsales() {
        return showsales;
    }

    public void setShowsales(Byte showsales) {
    ...
    public Integer getVerifygoodsnum() {
        return verifygoodsnum;
    }

    public void setVerifygoodsnum(Integer verifygoodsnum) {
        this.verifygoodsnum = verifygoodsnum;
    }

    public Integer getVerifygoodsdays() {
        return verifygoodsdays;
    }

    public void setVerifygoodsdays(Integer verifygoodsdays) {
        this.verifygoodsdays = verifygoodsdays;
    }

    public Boolean getVerifygoodslimittype() {
        return verifygoodslimittype;
    }

    public void setVerifygoodslimittype(Boolean verifygoodslimittype) {
        this.verifygoodslimittype = verifygoodslimittype;
    }

    public Integer getVerifygoodslimitdate() {
        return verifygoodslimitdate;
    }

    public void setVerifygoodslimitdate(Integer verifygoodslimitdate) {
    ...
    public void setMinliveprice(BigDecimal minliveprice) {
    ...
    public void setMaxliveprice(BigDecimal maxliveprice) {
    ...
    public Byte getIsstoreprice() {
        return isstoreprice;
    }

    public void setIsstoreprice(Byte isstoreprice) {
    ...
    public void setBeforehours(Integer beforehours) {
