            ...
            case 1:
                ...
                if(req!=null){
                    try {
                        ...
                        list = wealthService.queryPage(startTime,endTime,(req.getPageStart() - 1) * req.getPageSize(), req.getPageSize());

                        count = wealthService.queryPageCount(startTime,endTime);
                        page.setList(list);
